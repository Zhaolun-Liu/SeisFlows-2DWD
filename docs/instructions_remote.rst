...
1. Download SeisFlows-2DWD
---------------------

To run SeisFlows-2DWD you'll need a Unix system with Python 2.7, Numpy, Scipy, Obspy and standard Unix utilities.  After these prerequisites are in place, from the command line type::
